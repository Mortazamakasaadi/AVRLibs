...
#define LCD_BACKLIGHT_PORT LCD_PORT
#define LCD_BACKLIGHT	 7			  /**< pin  for Backlight line     */
...
/*Turns backlight of lcd on or off*/
extern void lcd_backlight(uint8_t backlight);
/**
