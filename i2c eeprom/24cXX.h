...
=================================================================================*/
unsigned char eep24cXX_read_byte (unsigned int I2C_24cXX,unsigned int address);
void eep24cXX_write_byte (unsigned int I2C_24cXX,unsigned int address, unsigned char data);
